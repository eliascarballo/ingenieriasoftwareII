...
?>
	...
	<body>
		...
		<form method=post>
			...
			{
				$alumno .= "<option value='$cantreg[id]'>$cantreg[0]</option>";
			}
			$alumno .= "</select>";
					echo "
			...
			echo "<td>$alumno<input name=agregar maxlength= 9 type=button value=Buscar_Alumno OnClick=\"location.replace('notas.php')\">";
?>
					<tr>
